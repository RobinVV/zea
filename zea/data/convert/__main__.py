...
def get_args():
    ...
    parser.add_argument("--dst_npz", type=str, default="None", help="Additional destination folder path if also saving to numpy")
    ...
    # MATLAB
    parser.add_argument("--frames", default=["all"], type=str, nargs="+",
    ...
    parser.add_argument("--convert_measurements", action="store_true",
        help="EchonetLVH: Only convert measurements CSV file"
    )
    parser.add_argument("--convert_images", action="store_true",
        help="EchonetLVH: Only convert image files"
    )
