...
def compute_pfield(
    ...
    Args:
        ...
        grid (array): Grid points where the pressure field is computed of shape (n_z, n_x, 3).
    ...
    Returns:
        ops.array: The (normalized) pressure field (across tx events) of shape (n_tx, n_z, n_x).
    """
    # medium params
...
def normalize_pressure_field(pfield, alpha: float = 1.0, percentile: float = 10.0):
    ...
    Args:
        pfield (array): The unnormalized pressure field array of shape (n_tx, n_z, n_x).
