...
def compute_pfield(
    ...
    Args:
        ...
        grid (array): Grid points where the pressure field is computed of shape (grid_size_z, grid_size_x, 3).
    ...
    Returns:
        ops.array: The (normalized) pressure field (across tx events) of shape (n_tx, grid_size_z, grid_size_x).
    """
    # medium params
